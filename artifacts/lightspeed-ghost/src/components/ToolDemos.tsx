...
const SHOWCASES: Showcase[] = [
  ...
  {
    anchor: "tool-plagiarism", icon: ShieldCheck, kicker: "Free · One Check Before You Submit · AI, Plagiarism & Peer Review", badge: "Free — no AI model",
    headline: "One click. AI, plagiarism, and a professor-style peer review.",
    desc: "The free tool at the top of the page. Click Check my writing once and it runs everything on your text: an AI detector, a plagiarism scan that traces every match to its real source, readability, grammar and tone — plus a professor-style peer review that auto-detects your paper type and gives you a grade estimate, a rubric read, fixes and likely questions. Upload a file with the + button. It never touches an AI model, so it's free.",
    bullets: [
      "Similarity measured against 10B+ indexed pages, every match traced to its source",
      "AI-content probability on the same report",
      "Peer review: auto-detected paper type, grade estimate & 3-reviewer panel",
      "Likely exam/defence questions + a downloadable PDF report",
    ],
    capabilities: ["Auto-detects paper type, level & citation style — no forms to fill", "Structural code plagiarism — MOSS-style fingerprinting"],
    cta: "Check your writing free",
    ctaNote: "Free forever · never touches an AI model · sign in for the full check + PDF",
    demo: <PlagiarismDemo />,
  },
  {
