          ...
          <div className="hidden md:flex items-center gap-2.5">
            {user ? (
              <>
                ...
                <Link href="/earnings"><span className="px-5 py-2.5 text-sm bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-semibold rounded-lg transition-colors cursor-pointer shadow-md shadow-[#6b38d4]/20">Your dashboard</span></Link>
              </>
            ) : (
              <Link href="/auth?next=/earnings"><span className="px-5 py-2.5 text-sm bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-semibold rounded-lg transition-colors cursor-pointer shadow-md shadow-[#6b38d4]/20">Get your link</span></Link>
            )}
          </div>
        ...
        {mobileOpen && (
          <div className="md:hidden bg-white border-t border-[#e0e3e5] px-4 py-4 space-y-1 shadow-lg">
            ...
            <div className="pt-3 border-t border-[#e0e3e5] mt-2 space-y-1.5">
              ...
              <Link href={user ? "/earnings" : "/auth?next=/earnings"}><span onClick={() => setMobileOpen(false)} className="block text-center px-4 py-2.5 text-sm bg-[#6b38d4] text-white font-semibold rounded-lg cursor-pointer">{user ? "Your dashboard" : "Get your link"}</span></Link>
            </div>
          </div>
        )}
      </header>
      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-28 pb-14 sm:pt-32 sm:pb-16 px-4 sm:px-6">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              {user ? (
                <Link href="/earnings"><span className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-bold rounded-lg transition-all cursor-pointer shadow-lg shadow-[#6b38d4]/25 hover:-translate-y-0.5 text-sm">
                  Go to your dashboard <ArrowRight size={16} />
                </span></Link>
              ) : (
                <Link href="/auth?next=/earnings"><span className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-bold rounded-lg transition-all cursor-pointer shadow-lg shadow-[#6b38d4]/25 hover:-translate-y-0.5 text-sm">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-[#131b2e] text-white">
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            {user ? (
              <button onClick={() => navigate("/earnings")} className="inline-flex items-center gap-2 px-8 py-4 bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-bold rounded-lg transition-all shadow-2xl hover:-translate-y-0.5 text-base">Open your dashboard <ArrowRight size={18} /></button>
            ) : (
              <button onClick={() => navigate("/auth?next=/earnings")} className="inline-flex items-center gap-2 px-8 py-4 bg-[#6b38d4] hover:bg-[#5b2fc0] text-white font-bold rounded-lg transition-all shadow-2xl hover:-translate-y-0.5 text-base">Get your link — it's free <ArrowRight size={18} /></button>
            )}
          </div>
        </section>
      </main>
