    ...
    <div className="min-h-screen bg-[#f7f9fb] text-[#191c1e] antialiased">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-[#45464d] leading-relaxed">
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Our Position on Academic Integrity</h2>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Prohibited Use</h2>
            <div className="space-y-3">
              {[
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Your Responsibility</h2>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Enforcement</h2>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">Questions</h2>
            <p>If you're unsure whether a specific use is appropriate, email us at <a href="mailto:info@lightspeedghost.com" className="text-[#10b981] hover:text-[#059669]">info@lightspeedghost.com</a>. We're happy to discuss it.</p>
          </section>
        </div>
      </main>
