...
const ARTICLES: ArticleMeta[] = [
  ...
  },
  {
    ...
    faqSchema: [
      ...
      { q: "What's included in the Starter plan?", a: "The Starter plan at $9.99/month includes 3 paper generations, 5 outlines, 5 plagiarism + AI checks, 1 revision, 15 STEM solves per month, and 20 study sessions per month." },
...
const ARTICLE_BODIES: Record<string, React.ReactNode> = {
  ...
  "payg-vs-subscription": (
    <div className="space-y-5 text-white/65 text-sm leading-relaxed">
      ...
      <p>The math: a standard essay-length paper (500–1,500 words) costs $7.99 PAYG. A research paper (1,500–3,500 words) is $14.99. If you write one essay a month, PAYG costs roughly $96/year. Starter at $9.99/month is $120/year for 3 papers per month — Starter almost always wins on cost, but PAYG wins on flexibility if your usage is truly unpredictable.</p>
    ...
    <div className="min-h-screen bg-[#04080f] text-white antialiased">
      ...
      <main className="max-w-2xl mx-auto px-6 py-14 sm:py-20">
        ...
        <div className="mt-14 p-6 rounded-2xl bg-blue-600/8 border border-blue-500/20 text-center">
          ...
          <p className="text-white/50 text-sm mb-5">Seven AI academic tools built specifically for students. Starter plan from $9.99/month — cancel any time.</p>
          <Link href="/auth">
