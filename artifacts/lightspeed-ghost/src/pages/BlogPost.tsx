...
const ARTICLES: ArticleMeta[] = [
  ...
  },
  {
    ...
    dateIso: "2025-02-12",
    metaDescription: "Compare pay-as-you-go credits vs. Light Speed Ghost's free and Pro plans. Find out which saves more money based on your actual writing frequency.",
    faqSchema: [
      ...
      { q: "What's included in the Free plan?", a: "The Free plan is $0 forever and includes the unlimited in-browser Writing Analyzer (AI detector, readability, grammar, tone) plus 3 plagiarism + AI checks per month using local detection. Your text never touches an AI model on the Free plan. AI generation requires Pro or pay-as-you-go credits." },
      { q: "When does it make sense to upgrade to Pro?", a: "If you're using 3 or more paper generations per month consistently, Pro at $29.99/month saves money over pay-as-you-go. If your usage is seasonal — heavy during finals, light otherwise — credits usually cost less." },
    ],
  },
  {
...
const ARTICLE_BODIES: Record<string, React.ReactNode> = {
  "literature-review-guide": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Define your scope before you read anything</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Organize thematically, never chronologically</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Show disagreement — it's your strongest asset</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Use primary sources, not secondary summaries</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">End with a gap statement that makes your study inevitable</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Common mistakes that cost marks</h3>
      ...
      <p className="pt-2 text-[#76777d] text-xs">Light Speed Ghost's Write Paper tool generates literature-grounded papers using sources verified through Semantic Scholar in real time. The AI queries an actual academic database before writing the literature section — sources are confirmed to exist before they appear in your paper.</p>
    </div>
  ),
  ...
  "ai-humanizer-vs-paraphrasing": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What AI detectors actually measure</h3>
      <p>The two most important signals are <strong className="text-[#191c1e]">perplexity</strong> and <strong className="text-[#191c1e]">burstiness</strong>.</p>
      <p><strong className="text-[#191c1e]">Perplexity</strong> measures how predictable a sequence of words is. Language models are trained to generate the most probable next word — which means AI text tends to be statistically "safe" and low-surprise. Human writing is messier, with more unexpected turns, deliberate variations, and stylistic idiosyncrasies. Low perplexity = AI-like. High perplexity = more human-like.</p>
      <p><strong className="text-[#191c1e]">Burstiness</strong> measures variation in sentence length. Humans naturally alternate between short sentences and long ones. AI models tend to produce sentences of consistent, medium length — grammatically perfect, structurally predictable. Low burstiness is a strong AI signal.</p>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Why paraphrasers fail</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What a real humanizer does differently</h3>
      <p>Effective AI humanization requires structural rewriting, not word substitution. Specifically:</p>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
        <li><strong className="text-[#45464d]">Vary sentence length deliberately.</strong> Follow a complex sentence with a short one. Break a long sentence into two. Merge two short ones. Create rhythm that mirrors human writing patterns.</li>
        <li><strong className="text-[#45464d]">Introduce controlled imperfection.</strong> Humans write with minor stylistic inconsistencies — word choice that's slightly unusual, a slightly informal turn of phrase in an otherwise formal paragraph. This increases perplexity.</li>
        <li><strong className="text-[#45464d]">Restructure at the paragraph level.</strong> Move points around. Start paragraphs differently. Vary the position of the topic sentence.</li>
        <li><strong className="text-[#45464d]">Add personal or contextual voice.</strong> First-person framing, hedged statements, and opinion markers all increase burstiness and perplexity in the right ways.</li>
      </ul>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">How Light Speed Ghost's humanizer works</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">When to use a humanizer and when not to</h3>
      ...
      <p className="pt-2 text-[#76777d] text-xs">Academic use note: always review humanized output for accuracy before submitting. The goal is to help you express ideas in your own voice — not to submit work that isn't yours. Check your institution's AI use policy before using any AI tool for academic work.</p>
    </div>
  ),
  ...
  "stem-problem-solving": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">The dangerous pattern: copy-paste answers</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Start with concepts, not calculations</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Ask for parallel problems, not just solutions</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Require step-by-step reasoning — every step</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Identify your weak problem types and track them</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Know when to close the AI and work alone</h3>
  ...
  "payg-vs-subscription": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">How pay-as-you-go credits work</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">When PAYG makes more sense</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
      ...
      <p>The math: a standard essay-length paper (500–1,500 words) costs $7.99 PAYG. A research paper (1,500–3,500 words) is $14.99. If you write one or two papers a month, PAYG stays well under a subscription — and you pay nothing at all in the months you don't write.</p>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Where the Free plan fits</h3>
      <p>Every account starts on the Free plan: the unlimited in-browser Writing Analyzer (AI detector, readability, grammar, tone) plus 3 plagiarism + AI checks per month with local detection — and your text never touches an AI model. It's the right home base if you mostly need to check your own writing, topping up with PAYG credits only when you need a paper generated, revised, or humanized.</p>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">When Pro is worth it</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
      ...
      <p>At $29.99/month, Pro provides 15 papers, 20 revisions, 20 humanizer jobs, 60 STEM solves, 150 study sessions, and 20 plagiarism checks per month. If you write three papers a month, that's $10 per paper — significantly below PAYG rates for equivalent output length. The math strongly favors Pro once you're consistently at or above that volume.</p>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">The honest recommendation</h3>
      <p>Stay on the Free plan with PAYG top-ups if you're testing the platform or your usage is genuinely unpredictable — you'll pay only for what you actually generate. Upgrade to Pro when you're using 3+ papers per month consistently or when you need the higher limits on revisions and humanizations.</p>
  ...
  "study-techniques-with-ai": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">1. Retrieval practice (active recall)</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">2. Spaced repetition</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">3. Elaborative interrogation</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">4. Interleaving</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">5. The Feynman technique</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What doesn't work (but feels like it does)</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
        <li><strong className="text-[#45464d]">Re-reading:</strong> Creates familiarity, not retention. You recognize material without being able to recall it under test conditions.</li>
        <li><strong className="text-[#45464d]">Highlighting:</strong> Feels active, is mostly passive. Doesn't produce retrieval practice or elaborative processing.</li>
        <li><strong className="text-[#45464d]">Summarizing:</strong> Useful as a warmup. Not effective as a primary study strategy compared to retrieval practice.</li>
        <li><strong className="text-[#45464d]">Massed practice (cramming):</strong> Works for the exam, fails within days. Material isn't consolidated into long-term memory.</li>
      </ul>
    </div>
  ),
  ...
  "citations-that-are-real": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Why hallucination happens</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What we do differently</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">How to verify citations yourself — always</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Warning signs that a citation may be hallucinated</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
      ...
      <p className="pt-2 text-[#76777d] text-xs">Real citations only: our paper writer queries Semantic Scholar before writing. When a verified source isn't available for your specific topic, we'll tell you — rather than invent one.</p>
    </div>
  ),
  ...
  "how-to-write-a-thesis-statement": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What a thesis statement must do</h3>
      <p>A functional thesis statement has three properties:</p>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d] mb-3">
        <li><strong className="text-[#45464d]">It's specific.</strong> "The French Revolution had many causes" is not a thesis — it's a fact that no one would dispute. "The financial collapse of the French state between 1786 and 1789, not ideological opposition to monarchy, was the primary catalyst of revolutionary action" is a thesis.</li>
        <li><strong className="text-[#45464d]">It's arguable.</strong> Someone should be able to disagree with it, with evidence, and the debate should be interesting. If no reasonable person could disagree, it's a statement of fact, not a thesis.</li>
        <li><strong className="text-[#45464d]">It's scoped to your paper.</strong> A thesis you can't fully defend in your page limit is a thesis you shouldn't be writing. Narrow it until the paper can actually prove it.</li>
      </ul>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">The specific + "so what" formula</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Where the thesis goes and how long it should be</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Thesis statements for different paper types</h3>
      <p><strong className="text-[#191c1e]">Argumentative paper:</strong> Your thesis takes a position: "X is true because of Y and Z, despite the objection that W." It signals both the claim and the strongest counterargument you'll address.</p>
      <p><strong className="text-[#191c1e]">Analytical paper:</strong> Your thesis explains what your analysis reveals: "Through an examination of X and Y, this paper argues that Z, challenging the conventional view that W."</p>
      <p><strong className="text-[#191c1e]">Expository paper:</strong> Your thesis states what the paper explains and why it matters: "This paper examines three mechanisms by which X produces Y, with implications for our understanding of Z."</p>
      <p><strong className="text-[#191c1e]">Research paper:</strong> Your thesis states your findings: "This study finds that X is significantly associated with Y in population Z, suggesting that the conventional model of W requires revision."</p>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Common mistakes that professors spot immediately</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
        <li><strong className="text-[#45464d]">Announcing instead of arguing:</strong> "This paper will discuss the causes of World War I" is an agenda, not a thesis. State your argument, not your plan.</li>
        <li><strong className="text-[#45464d]">Asking a question:</strong> "Was the New Deal effective?" A thesis answers the question, it doesn't ask it.</li>
        <li><strong className="text-[#45464d]">Being too broad:</strong> "Climate change is a serious issue" cannot be defended or disputed. It's trivially true.</li>
        <li><strong className="text-[#45464d]">The two-headed thesis:</strong> Two disconnected arguments that the paper can't fully develop: "Income inequality harms economic growth and also reduces social mobility." Pick one, or explain the connection.</li>
        <li><strong className="text-[#45464d]">Forgetting to revise it:</strong> A thesis written before the paper often doesn't match what the paper actually argues. Revise the thesis last, after the body is written.</li>
      </ul>

      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Writing the thesis after the paper</h3>
      ...
      <p className="pt-2 text-[#76777d] text-xs">Light Speed Ghost's Write Paper tool generates papers from your topic, requirements, and academic level. The output includes a developed thesis that aligns with the paper's argument — and all citations are verified against Semantic Scholar in real time.</p>
    </div>
  ),
  ...
  "lower-ai-detection-score": (
    <div className="space-y-5 text-[#45464d] text-sm leading-relaxed">
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Understand what detectors are actually measuring</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Step 1 — Diagnose before fixing</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Step 2 — Fix sentence length variation first</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Step 3 — Increase perplexity through word choice</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Step 4 — Inject personal or contextual voice</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">Step 5 — Run through a humanizer, then verify</h3>
      ...
      <h3 className="text-[#191c1e] font-semibold text-base mt-7">What doesn't work</h3>
      <ul className="list-disc list-inside space-y-1.5 text-[#45464d]">
        <li><strong className="text-[#45464d]">Synonym replacement tools:</strong> Change wording, preserve structure. Detectors don't care about wording.</li>
        <li><strong className="text-[#45464d]">Adding filler sentences:</strong> Padding doesn't change the statistical properties of the existing text.</li>
        <li><strong className="text-[#45464d]">Changing fonts or inserting invisible characters:</strong> Modern detectors are robust to these tricks, and institutions may flag them as separate integrity violations.</li>
        <li><strong className="text-[#45464d]">Rerunning the same AI model:</strong> Regenerating from the same model produces statistically similar text. The structural problem doesn't change.</li>
      </ul>
      <p className="pt-2 text-[#76777d] text-xs">Academic integrity note: AI tools are assistants, not replacements for your own thinking. Use them to draft, refine, and support — but the argument, judgment, and understanding need to be yours. Check your institution's AI policy before submitting any AI-assisted work.</p>
    </div>
  ),
};
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fb] text-[#191c1e] antialiased">
      <header className="border-b border-[#eceef0] px-6 h-16 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <Link href="/blog">
          <span className="flex items-center gap-1.5 text-sm text-[#76777d] hover:text-[#191c1e] transition-colors cursor-pointer">
      ...
      <main className="max-w-2xl mx-auto px-6 py-14 sm:py-20">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 text-[#76777d] text-xs">
        ...
        {article.faqSchema && article.faqSchema.length > 0 && (
          <div className="mt-12 space-y-4">
            <h2 className="text-[#191c1e] font-semibold text-lg">Frequently asked questions</h2>
            {article.faqSchema.map(({ q, a }) => (
              <div key={q} className="rounded-xl border border-[#e0e3e5] bg-white p-5">
                <p className="text-[#191c1e] text-sm font-semibold mb-2">{q}</p>
                <p className="text-[#45464d] text-sm leading-relaxed">{a}</p>
              </div>
            ))}
          </div>
        )}
        ...
        {otherArticles.length > 0 && (
          <div className="mt-14">
            <p className="text-xs font-semibold text-[#76777d] uppercase tracking-widest mb-5">More articles</p>
            <div className="space-y-3">
              {otherArticles.map((a) => (
                <a key={a.slug} href={`/blog/${a.slug}`} className="flex items-center justify-between p-4 rounded-xl bg-white border border-[#eceef0] hover:border-[#e0e3e5] hover:bg-white transition-all group cursor-pointer">
                  <div>
                    <span className={`inline-flex items-center gap-1 text-[9px] font-semibold px-1.5 py-0.5 rounded-full border mb-1 ${a.tagColor}`}>
                      {a.tag}
                    </span>
                    <p className="text-sm text-[#45464d] group-hover:text-[#191c1e] transition-colors leading-snug">{a.title}</p>
                  </div>
                  <ArrowRight size={14} className="text-[#c6c6cd] group-hover:text-[#45464d] shrink-0 ml-4 transition-colors" />
                </a>
              ))}
            </div>
          </div>
      ...
      <footer className="border-t border-[#eceef0] py-8 px-6 text-center mt-10">
