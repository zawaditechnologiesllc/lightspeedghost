      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-white/70 leading-relaxed">
          ...
          <section>
            ...
            <p>
              The Starter plan is a paid monthly plan at $4.99/month and is subject to the same refund terms as other paid plans in Section 2. If you upgrade from Starter to Pro or Institution, the higher-tier plan terms in Section 2 apply from the date of upgrade.
            </p>
          </section>
