  ...
  return (
    <div className="min-h-screen bg-[#eef7f1] text-[#191c1e] antialiased">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-[#76777d] text-sm mb-12">Last updated: July 2026 · Effective immediately</p>

        <div className="space-y-10 text-[#45464d] leading-relaxed">

          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">1. Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">2. Subscriptions</h2>

            <h3 className="text-[#191c1e] font-semibold mb-2 mt-5">2.1 Monthly Plans (Pro)</h3>
            <p>
            ...
            <h3 className="text-[#191c1e] font-semibold mb-2 mt-5">2.2 Annual Plans (Pro Annual, Campus Annual)</h3>
            <p>
              Annual plans may be eligible for a prorated refund if a refund request is submitted within <strong className="text-[#191c1e]">14 days</strong> of the initial purchase date, provided that no more than one (1) document generation has been completed using the subscription. After 14 days, or after meaningful use of the service, annual plans are non-refundable.
            </p>

            <h3 className="text-[#191c1e] font-semibold mb-2 mt-5">2.3 Duplicate or Accidental Charges</h3>
            <p>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">3. Pay-As-You-Go (PAYG) Purchases</h2>
            <p>
              PAYG purchases are single-use purchases for specific tools (paper generation, humanizer, STEM solver, etc.). Because the service is delivered immediately upon payment, PAYG purchases are <strong className="text-[#191c1e]">non-refundable</strong> once processing has begun.
            </p>
            <p className="mt-3">
              Exceptions apply in the following circumstances:
            </p>
            <ul className="list-disc pl-5 space-y-2 mt-3">
              <li><strong className="text-[#191c1e]">Technical failure:</strong> If the service fails to deliver output due to a confirmed platform error (not an error caused by your input), we will either re-run the service at no additional charge or issue a full refund of the purchase amount.</li>
              <li><strong className="text-[#191c1e]">Accidental duplicate purchase:</strong> If you purchased the same tool for the same document twice within 10 minutes and can demonstrate that no output from the second purchase was used, we will refund the second charge.</li>
              <li><strong className="text-[#191c1e]">Charge without output:</strong> If your payment was processed but no output was generated and no credits were applied to your account, you are entitled to a full refund.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">4. Credit Top-Ups</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">5. Free Plan and Legacy Plans</h2>
            <p>
              The Free plan is provided at no charge and involves no payment, so no refund terms apply to it. Legacy paid plans that are no longer offered for new purchase (such as the former Starter plan at $9.99/month) remain subject to the same refund terms as other paid plans in Section 2 for existing subscribers. If you upgrade from a legacy plan to Pro or Institution, the higher-tier plan terms in Section 2 apply from the date of upgrade.
            </p>
          </section>

          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">6. Chargebacks and Disputes</h2>
            <p>
          ...
          <section>
            ...
            <p className="mt-4">
              We will acknowledge your request within <strong className="text-[#191c1e]">2 business days</strong> and resolve eligible cases within <strong className="text-[#191c1e]">5 business days</strong>. Approved refunds are returned to your original payment method and typically appear within 5–10 business days depending on your bank.
            </p>
          </section>

          <section>
            <h2 className="text-[#191c1e] text-xl font-semibold mb-4">8. Regional Consumer Rights</h2>
            <p>
      ...
      <footer className="border-t border-[#eceef0] py-8 px-6 text-center mt-16">
        <p className="text-[#9a9aa1] text-xs">© {new Date().getFullYear()} Light Speed Ghost. All rights reserved. · <a href="mailto:billing@lightspeedghost.com" className="hover:text-[#45464d]">billing@lightspeedghost.com</a></p>
      </footer>
    </div>
  );
}
