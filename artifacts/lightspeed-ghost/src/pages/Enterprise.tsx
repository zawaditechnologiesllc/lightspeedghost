...
export default function Enterprise() {
  ...
  const inputClass = "w-full bg-white border border-[#c6c6cd] rounded-lg px-4 py-3 text-[#191c1e] text-sm placeholder:text-[#76777d] focus:outline-none focus:border-[#10b981] focus:ring-1 focus:ring-[#10b981] transition-all";
    ...
    <div className="min-h-screen bg-[#eef7f1] text-[#191c1e] antialiased overflow-x-hidden selection:bg-[#10b981]/20">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#e0e3e5] transition-all duration-300 ${scrolled ? "shadow-md bg-white/95 backdrop-blur-md" : ""}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <a href="#contact" className="px-4 py-2 text-sm text-[#45464d] hover:text-[#10b981] transition-colors cursor-pointer">Talk to sales</a>
            <a href="#contact" className="px-5 py-2.5 text-sm bg-[#10b981] hover:bg-[#059669] text-white font-semibold rounded-lg transition-colors cursor-pointer shadow-md shadow-[#10b981]/20 whitespace-nowrap">
              Request a quote
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-bold leading-[1.05] tracking-tight mb-5 text-[#131b2e]" style={{ letterSpacing: "-0.02em" }}>
              Institutional <span className="text-[#10b981]">licensing.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-6 mb-8">
              <div className="flex flex-col border-l-4 border-[#10b981] pl-4">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              <a href="#contact" className="inline-flex items-center gap-2 px-7 py-4 bg-[#10b981] hover:bg-[#059669] text-white font-bold rounded-lg transition-all shadow-lg shadow-[#10b981]/25 hover:-translate-y-0.5 text-sm sm:text-base">
                <Zap size={15} />
                Start 30-Day Pilot
              </a>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-[#e0e3e5] bg-white">
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    { label: "Active seats", value: "1,182", color: "text-[#10b981]" },
      ...
      <section className="border-y border-[#e0e3e5] bg-[#e8f3ed] py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 sm:gap-x-12 gap-y-3 opacity-70">
            ...
            <span className="text-xs font-semibold text-[#10b981]">+200 more</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <StaggerGrid className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {valueProps.map(({ icon: Icon, title, desc, featured, dark }) => {
                ...
                return (
                  <m.div key={title} variants={cardVariant} className="md:col-span-2 rounded-2xl border border-[#e0e3e5] bg-white p-6 sm:p-8 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div className="mt-8 pt-4 border-t border-[#e0e3e5] flex justify-between items-center">
                      <span className="text-xs font-bold text-[#10b981] uppercase tracking-widest">Real-time reporting</span>
              ...
              return (
                <m.div key={title} variants={cardVariant} className="rounded-2xl border border-[#e0e3e5] bg-white p-6 sm:p-7 shadow-sm hover:shadow-md hover:border-[#10b981]/40 transition-all">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <StaggerGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {toolList.map(({ name, note }) => (
              <m.div key={name} variants={cardVariant} className="group bg-white p-5 rounded-xl border border-[#e0e3e5] shadow-sm hover:border-[#10b981] hover:shadow-md transition-all flex flex-col gap-3">
                <div className="w-11 h-11 rounded-full bg-[#d1fae5] flex items-center justify-center text-[#10b981] group-hover:bg-[#10b981] group-hover:text-white transition-all">
                  <CheckCircle size={20} />
                </div>
                <div>
      ...
      <section id="pricing" className="py-14 sm:py-20 md:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <FadeUp>
            <div className="text-center mb-10 sm:mb-14">
              <p className="text-[#10b981] text-sm font-bold uppercase tracking-widest mb-3">Institutional pricing</p>
          ...
          <StaggerGrid className="grid md:grid-cols-3 gap-5 sm:gap-6 items-start">
            {tiers.map(({ name, seats, price, per, annual, desc, features, cta, highlight, badge }) => (
              ...
              >
                ...
                <p className={`text-xs font-medium mb-3 ${highlight ? "text-[#6ee7b7]" : "text-[#10b981]"}`}>{seats}</p>
                ...
                <a href="#contact" className={`block text-center py-3 rounded-lg font-bold text-sm transition-all ${highlight ? "bg-[#10b981] hover:bg-[#059669] text-white shadow-lg shadow-[#10b981]/30" : "border border-[#10b981] text-[#10b981] hover:bg-[#10b981]/5"}`}>
                  {cta}
                </a>
              </m.div>
            ))}
          ...
          <FadeUp delay={0.1} className="mt-10">
            <div className="rounded-2xl border border-[#e0e3e5] bg-white p-6 sm:p-8 text-center shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="#contact" className="inline-flex items-center gap-2 px-6 py-3 bg-[#10b981] hover:bg-[#059669] text-white font-semibold rounded-lg transition-all text-sm shadow-md shadow-[#10b981]/20">
                  <Zap size={14} />
                  Request a quote
                </a>
                <a href="mailto:enterprise@lightspeedghost.com" className="inline-flex items-center gap-2 px-6 py-3 border border-[#c6c6cd] text-[#45464d] hover:text-[#10b981] hover:border-[#10b981] rounded-lg transition-all text-sm">
                  <Mail size={14} />
        ...
        <div className="max-w-2xl mx-auto">
          <FadeUp>
            <div className="text-center mb-10">
              <p className="text-[#10b981] text-sm font-bold uppercase tracking-widest mb-3">Get in touch</p>
            ...
            {formState === "success" ? (
              ...
              >
                ...
                <p className="text-[#76777d] text-xs mt-4">
                  ...
                  <a href="mailto:enterprise@lightspeedghost.com" className="text-[#10b981] hover:underline">enterprise@lightspeedghost.com</a>
                </p>
              </m.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4 rounded-2xl border border-[#e0e3e5] bg-white p-6 sm:p-8 shadow-sm">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-[#45464d] mb-1.5">Institution name <span className="text-[#10b981]">*</span></label>
                    <input
                      required
                      name="institution"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#45464d] mb-1.5">Your name <span className="text-[#10b981]">*</span></label>
                    <input
                      required
                      name="name"
                      value={form.name}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-[#45464d] mb-1.5">Email address <span className="text-[#10b981]">*</span></label>
                    <input
                      required
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#45464d] mb-1.5">Your role <span className="text-[#10b981]">*</span></label>
                    <select
                      required
                      name="role"
                      value={form.role}
                ...
                <div>
                  <label className="block text-xs font-semibold text-[#45464d] mb-1.5">Estimated student count <span className="text-[#10b981]">*</span></label>
                  <input
                    required
                    name="studentCount"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 bg-[#10b981] hover:bg-[#059669] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-lg transition-all shadow-md shadow-[#10b981]/20 text-sm"
                >
                ...
                <p className="text-center text-[#76777d] text-xs">
                  ...
                  <a href="mailto:enterprise@lightspeedghost.com" className="text-[#10b981] hover:text-[#059669] transition-colors">
                    enterprise@lightspeedghost.com
                  </a>
                </p>
              </form>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 relative overflow-hidden bg-[#131b2e] text-white">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#10b981]/20 rounded-full blur-[100px]" />
        </div>
        <div className="relative max-w-2xl mx-auto text-center">
          <FadeUp>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <a href="#contact" className="inline-flex items-center gap-2 px-8 py-4 bg-[#10b981] hover:bg-[#059669] text-white font-bold rounded-lg transition-all shadow-2xl hover:-translate-y-0.5 text-sm sm:text-base">
                <Zap size={15} />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1.5 text-xs text-[#76777d]">
              ...
              <Link href="/africa"><span className="hover:text-[#10b981] cursor-pointer transition-colors">For African Students</span></Link>
