...
import { Ghost, Lock, Eye, EyeOff, CheckCircle, AlertCircle, Loader2, User } from "lucide-react";
        ...
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8">
          {status === "done" ? (
            <div className="text-center py-4">
              ...
              <p className="text-white/50 text-sm mb-6">Your account is set up. Start writing.</p>
              <Link href="/app">
            ...
            <div className="text-center py-4">
              ...
              <h2 className="text-xl font-bold text-white mb-2">Invite link expired</h2>
              <p className="text-white/50 text-sm mb-6">This invite link has expired or already been used. Ask for a new one.</p>
              <Link href="/">
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm text-white/60 mb-1.5">Your name <span className="text-white/25">(optional)</span></label>
                ...
                <div>
                  <label className="block text-sm text-white/60 mb-1.5">Set a password</label>
                  <div className="relative">
