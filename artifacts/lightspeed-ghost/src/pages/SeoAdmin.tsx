...
// Public SEO pages live on the main domain at /seo/<slug>. A serverless proxy
// (Vercel api/seo-proxy.js today, or the Cloudflare Pages function once cut
// over) forwards them to the backend renderer, so we link to the main domain
// and never expose the backend URL.
